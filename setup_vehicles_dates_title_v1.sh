Q#!/bin/bash
set -e
echo "=== מתקן תצוגת תאריכים ומסך פרטי הרכב ==="

mkdir -p lib/models lib/features/vehicles

echo "כותב lib/models/vehicle_model.dart..."
cat > lib/models/vehicle_model.dart << 'DATES_TITLE_EOF'
...
cat > lib/features/vehicles/add_edit_vehicle_screen.dart << 'DATES_TITLE_EOF'
...
cat > lib/features/vehicles/add_service_record_screen.dart << 'DATES_TITLE_EOF'
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import '../../app/config/app_strings.dart';
import '../../app/config/app_text_styles.dart';
...
cat > lib/features/vehicles/vehicle_detail_screen.dart << 'DATES_TITLE_EOF'
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
...
entries = [('vehicleDetailsTitle', 'פרטי הרכב')]
