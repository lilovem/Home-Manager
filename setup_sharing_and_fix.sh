...
HMEOF
cat > 'lib/services/sharing/share_service.dart' << 'HMEOF'
export 'share_service_stub.dart' if (dart.library.html) 'share_service_web.dart';

HMEOF
cat > 'lib/services/sharing/share_service_web.dart' << 'HMEOF'
...
HMEOF
cat > 'lib/services/sharing/share_service_stub.dart' << 'HMEOF'
...
HMEOF
cat > 'lib/providers/share_provider.dart' << 'HMEOF'
...
HMEOF
echo 'DONE - sharing buttons added, underline removed!'
