#!/bin/bash
set -e
mkdir -p lib/features/bills lib/services/firebase
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            Text('${AppStrings.vaadBayitTitle} · $_year'),
            IconButton(
              icon: const Icon(Icons.chevron_left),
              onPressed: () => setState(() => _year++),
            ),
...
HMEOF
echo 'DONE - deferred reminder save, year navigation, and fixed swipe direction!'
